...
#
## Copy fat jar
#COPY target/otp2-week2-1.0-SNAPSHOT.jar .

# Run the **shaded JAR** with JavaFX modules
CMD ["java", "--module-path", "/opt/javafx-sdk-21/lib", "--add-modules", "javafx.controls,javafx.fxml", "-jar", "otp2-week2-1.0-SNAPSHOT.jar"]